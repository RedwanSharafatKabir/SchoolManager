package com.school.manager.Authentication;
...
import com.school.manager.AppAction.MainActivity;
import com.school.manager.AppAction.SplashScreen;
...
public class SigninTcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox = findViewById(R.id.rememberCheckBoxID);
        checkBox.setChecked(true);
        signinPhoneText = findViewById(R.id.signinPhoneTcID);
        signinpasswordText = findViewById(R.id.signinPasswordTcID);
    }
                            ...
                            mAuth.signInWithEmailAndPassword(emailObj, passObj).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        waitingDialog.dismiss();
                                        finish();
                                        Intent it = new Intent(SigninTcActivity.this, MainActivity.class);
                                        startActivity(it);
    ...
    public void backToSplashScreen(View v){
        finish();
        Intent it = new Intent(SigninTcActivity.this, SplashScreen.class);
        startActivity(it);
